...
<script setup>
  ...
  const items = [
    ...
    {name: "Runaan's Hurricune", img: "/items-picture/Runaan's_Hurricane.png", stats: {"Attack Speed":"+40%", "Critical Strike Chance":"+25%", "Movement Speed":"+4%"}},
    {name: "Rylai's Crystal Scepter", img: "/items-picture/Rylai's_Crystal_Scepter.png", stats: {"Ability Power":"+65", "Health":"+400"}},
